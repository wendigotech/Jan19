...
<div class="hero">
    ...
    </div><?php if ( have_posts() ) : ?><div <?php post_class( 'steps landing__section' ); ?> id="post-<?php the_ID(); ?>">

        <div class="container">
            <div class="steps__inner">
                <div class="blog-slider">
                    <div class="blog-slider__wrp swiper-wrapper">
                        <?php while ( have_posts() ) : the_post(); ?><div class="blog-slider__item swiper-slide">
