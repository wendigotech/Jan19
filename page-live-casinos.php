...
<div class="hero">
    ...
    </div><?php get_template_part( 'content', get_post_format() ); ?><?php if ( have_posts() ) : ?><?php while ( have_posts() ) : the_post(); ?><div <?php post_class( 'expanded landing__section' ); ?> id="post-<?php the_ID(); ?>">
