...
<div class="hero">
    ...
    </div><?php get_template_part( 'content', 'choice' ); ?><?php if ( have_posts() ) : ?><?php while ( have_posts() ) : the_post(); ?><div style="background-color: #f6f6f6;" <?php post_class( 'expanded landing__section' ); ?> id="post-<?php the_ID(); ?>">
