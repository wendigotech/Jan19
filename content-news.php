<div class="steps landing__section">
    ...
    ?><?php $news = new WP_Query( $news_args ); ?><?php if ( $news->have_posts() ) : ?><div class="container">
                    ...
                    <a class="btn float-right btn-dark" href="<?php echo esc_url( get_theme_mod( 'submenu_link1' ) ); ?>"><?php _e( 'All News', 'jan19' ); ?></a></div><?php else : ?><p><?php _e( 'Sorry, no posts matched your criteria.', 'jan19' ); ?></p><?php endif; ?>
                </div>